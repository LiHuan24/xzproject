...
public class AlipayConfig {
	...
	// 合作身份者ID，签约账号，以2088开头由16位纯数字组成的字符串，查看地址：https://b.alipay.com/order/pidAndKey.htm
		...
		//public static String return_url = "http://127.0.0.1:9000/create_direct_pay_by_user-JAVA-UTF-8/return_url.jsp";
	...
	public static String getString(String key) {
		...
		try {//\tmp0\wtpwebapps\ec-mall\WEB-INF\classes\alipay.properties (系统找不到指定的文件。)
			InputStream in = new BufferedInputStream(new FileInputStream(
					(getAppPath() + "alipay.properties")));
			props.load(in);
