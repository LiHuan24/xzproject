 ...
 * 排课表 数据实体类
 */
public class ArrayCourse extends Entity<String> {
	...
	public String toString() {
		return "ArrayCourse [" + "arrayCourseNo = " + arrayCourseNo + ", storeNo = " + storeNo + ", storeName = "
				+ storeName + ", courseNo = " + courseNo + ", chineseName = " + chineseName + ", courseStart = "
				+ courseStart + ", courseStartStart = " + courseStartStart + ", courseStartEnd = " + courseStartEnd
				+ ", courseEnd = " + courseEnd + ", courseEndStart = " + courseEndStart + ", courseEndEnd = "
				+ courseEndEnd + ", courseDate = " + courseDate + ", courseDateStart = " + courseDateStart
				+ ", courseDateEnd = " + courseDateEnd + ", courseWeek = " + courseWeek + ", coachNo = " + coachNo
				+ ", coachName = " + coachName + ", peopleNumber = " + peopleNumber + ", reservation = " + reservation
				+ ", lineUp = " + lineUp + ", courseType = " + courseType + ", createTime = " + createTime
				...
				+ ", operatorType = " + operatorType + ", operatorId = " + operatorId + ", postedStatus = "
				+ postedStatus + ", storeAreaCode = "+ storeAreaCode + "]";
	}
}
