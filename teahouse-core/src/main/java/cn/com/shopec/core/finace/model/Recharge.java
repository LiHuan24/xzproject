 ...
 * 充值包表 数据实体类
 */
public class Recharge extends Entity<String> {
	...
	public String toString() {
		return "Recharge [" + "rechargeNo = " + rechargeNo + ", rechargeName = " + rechargeName + ", cityId = " + cityId
				+ ", cityName = " + cityName + ", price = " + price + ", rechargeAmount = " + rechargeAmount
				+ ", isEnable = " + isEnable + ", cencorStatus = " + cencorStatus + ", cencorMemo = " + cencorMemo
				+ ", cencorTime = " + cencorTime + ", cencorTimeStart = " + cencorTimeStart + ", cencorTimeEnd = "
				+ cencorTimeEnd + ", cencorId = " + cencorId + ", isDeleted = " + isDeleted + ", createTime = "
