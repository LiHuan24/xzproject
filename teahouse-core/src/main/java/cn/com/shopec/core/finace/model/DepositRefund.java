...
public class DepositRefund extends Entity<String> {
	...
	public String toString() {
		return "DepositRefund [" + "refundNo = " + refundNo + ", depositOrderNo = " + depositOrderNo
				...
				+ ", cencorConfirmItem = " + cencorConfirmItem + ", refundMemo = " + refundMemo + ", refundFailInfo = "
				+ refundFailInfo + ", cencorMemo = " + cencorMemo + ", createTime = " + createTime
