...
public class MemberZhimaScoreServiceImpl implements MemberZhimaScoreService {
	 ...
	 * 
	 * @param memberZhimaScore
	 *            新增的MemberZhimaScore数据（如果无特殊需求，新增对象的主键值请保留为null）
	 * @param operator
	 *            操作人对象
	 * @return
	 */
	 ...
	 * 
	 * @param memberZhimaScore
	 *            更新的MemberZhimaScore数据，且其主键不能为空
	 * @param operator
	 *            操作人对象
	 * @return
	 */
	...
	public ResultInfo<MemberZhimaScore> getScoreForZhiMa(MemberZhimaScore memberZhimaScore) throws Exception {
		...
		// 判断参数
		if (memberZhimaScore == null || memberZhimaScore.getMemberNo() == null
				|| memberZhimaScore.getOpenId() == null) { // 传入参数无效时直接返回失败结果
			resultInfo.setCode(Constant.FAIL);
			resultInfo.setMsg(Constant.ERR_MSG_INVALID_ARG);
			return resultInfo;
		}
