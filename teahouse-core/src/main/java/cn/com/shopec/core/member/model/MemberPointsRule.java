 ...
 * 会员积分规则表 数据实体类
 */
public class MemberPointsRule implements Serializable {
	...
	public String toString() {
		return "MemberPointsRule [ruleId=" + ruleId + ", businessType=" + businessType + ", pointsType=" + pointsType
				+ ", pointsValue=" + pointsValue + ", isDefault=" + isDefault + ", isAvailable=" + isAvailable
				+ ", isDeleted=" + isDeleted + ", operatorType=" + operatorType + ", operatorId=" + operatorId
