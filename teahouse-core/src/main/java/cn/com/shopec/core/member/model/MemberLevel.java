...
public class MemberLevel implements Serializable {
	...
	public String toString() {
		return "MemberLevel [memberLevelId=" + memberLevelId + ", levelName=" + levelName + ", levelDiscount="
				+ levelDiscount + ", upgradePoint=" + upgradePoint + ", memo=" + memo + ", isAvailable=" + isAvailable
