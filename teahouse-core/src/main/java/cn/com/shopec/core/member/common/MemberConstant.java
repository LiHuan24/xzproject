...
public class MemberConstant {
	...
	/** 获取信息成功 */
	public static final String success_msg = "获取信息成功";
	/** 系统错误 */
	...
	/** 芝麻信用分数 */
	public static final String ZMXY_FRACTION = "ZMXY_FRACTION";
	/** 预付费 */
	...
	/** 会员统计 1 日统计 2 月统计 3 年统计 **/
	public static final String STAT_DAY_MEMBER = "1";
	public static final String STAT_MONTH_MEMBER = "2";
	public static final String STAT_YEAR_MEMBER = "3";
}
