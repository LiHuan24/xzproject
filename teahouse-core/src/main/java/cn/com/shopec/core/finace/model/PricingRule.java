...
public class PricingRule extends Entity<String> {
	...
	public String toString() {
		return "PricingRule ["
		 + "ruleNo = " + ruleNo + ", ruleName = " + ruleName + ", cityId = " + cityId + ", cityName = " + cityName
		 + ", hourPrice = " + hourPrice + ", dayCap = " + dayCap + ", consumptionQuota = " + consumptionQuota + ", isEnable = " + isEnable
		 + ", cencorStatus = " + cencorStatus + ", cencorMemo = " + cencorMemo + ", cencorTime = " + cencorTime + ", cencorTimeStart = " + cencorTimeStart + ", cencorTimeEnd = " + cencorTimeEnd + ", cencorId = " + cencorId
