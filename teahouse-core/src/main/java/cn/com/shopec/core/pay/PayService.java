...
public interface PayService extends BaseService {
	 ...
	 */
	/*
	 * public ResultInfo<String> alipayGetOrderStr(HttpServletRequest request,
	 * HttpServletResponse response,String payNo,String memberNo,String
	 * packageNo,Integer type);
	 */
	ResultInfo<String> alipayGetOrderStr(HttpServletRequest request, HttpServletResponse response, String memberNo,
			String businessNo, Integer type,PayThemeOrderVo param);
