 ...
 * 课程包订单表 数据实体类
 */
public class CoursePackageOrder extends Entity<String> {
	...
	public String toString() {
		return "CoursePackageOrder [" + "rechargeOrderNo = " + rechargeOrderNo + ", memberNo = " + memberNo
				+ ", memberName = " + memberName + ", mobilePhone = " + mobilePhone + ", coursePackageNo = "
				+ coursePackageNo + ", coursePackageName = " + coursePackageName + ", payableAmount = " + payableAmount
				+ ", payStatus = " + payStatus + ", paymentMethod = " + paymentMethod + ", partTradeFlowNo = "
				+ partTradeFlowNo + ", isAvailable = " + isAvailable + ", invoiceId = " + invoiceId + ", invoiceNo = "
				+ invoiceNo + ", invoiceStatus = " + invoiceStatus + ", createTime = " + createTime
