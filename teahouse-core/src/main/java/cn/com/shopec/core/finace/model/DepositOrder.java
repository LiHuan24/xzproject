...
public class DepositOrder extends Entity<String> {
	...
	public String toString() {
		return "DepositOrder [" + "depositOrderNo = " + depositOrderNo + ", memberNo = " + memberNo
				+ ", depositAmount = " + depositAmount + ", payableAmount = " + payableAmount + ", payStatus = "
				+ payStatus + ", paymentMethod = " + paymentMethod + ", paymentFlowNo = " + paymentFlowNo
				...
				+ ", refundAmount = " + refundAmount + ", frozenAmount = " + frozenAmount + ", isAvailable = "
				+ isAvailable + ", partTradeFlowNo = " + partTradeFlowNo + ", createTime = " + createTime
