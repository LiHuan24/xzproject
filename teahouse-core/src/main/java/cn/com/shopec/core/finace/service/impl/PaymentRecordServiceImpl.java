...
public class PaymentRecordServiceImpl implements PaymentRecordService {
	...
	public List<PaymentRecord> getPaymentRecordList(Query q) {
		...
		try {
			// 已删除的不查出
			PaymentRecord paymentRecord = (PaymentRecord) q.getQ();
			if (paymentRecord != null) {
				paymentRecord.setIsDeleted(Constant.DEL_STATE_NO);
			}
	...
	public ResultInfo<PaymentRecord> delPaymentRecord(String id, Operator operator) {
		...
		try {
			...
			paymentRecord.setPaymemtId(id);
			paymentRecord.setIsDeleted(Constant.DEL_STATE_YES);
	 ...
	 * 
	 * @param paymentRecord
	 *            新增的PaymentRecord数据（如果无特殊需求，新增对象的主键值请保留为null）
	 * @param operator
	 *            操作人对象
	 * @return
	 */
	 ...
	 */
	@Override
	public PaymentRecord getPaymentRecordByFlowNo(String paymentFlowNo) {
		
		return paymentRecordDao.getPaymentRecordByFlowNo(paymentFlowNo);
	}
