...
import cn.com.shopec.core.finace.dao.PricingRuleDao;
...
public class PricingRuleServiceImpl implements PricingRuleService {
	...
	public List<PricingRule> getPricingRuleList(Query q) {
		...
		try {
			//已删除的不查出
			PricingRule pricingRule = (PricingRule)q.getQ();
			if (pricingRule != null) {
				pricingRule.setIsDeleted(Constant.DEL_STATE_NO);
			}
	...
	public ResultInfo<PricingRule> delPricingRule(String id, Operator operator) {
		...
		try {
			...
			pricingRule.setRuleNo(id);
			pricingRule.setIsDeleted(Constant.DEL_STATE_YES);
	...
	public String generatePK() {
		return "J" + primarykeyService.getValueByBizType(PrimarykeyConstant.pricingRule);
	}
