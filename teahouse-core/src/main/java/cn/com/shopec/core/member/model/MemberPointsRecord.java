...
public class MemberPointsRecord implements Serializable {
	...
	public String toString() {
		return "MemberPointsRecord [recordId=" + recordId + ", businessType=" + businessType + ", pointsType="
				+ pointsType + ", opType=" + opType + ", pointsValue=" + pointsValue + ", businessData=" + businessData
				+ ", memberNo=" + memberNo + ", memberName=" + memberName + ", recordMemo=" + recordMemo
				+ ", operatorType=" + operatorType + ", operatorId=" + operatorId + ", createTime=" + createTime
				+ ", updateTime=" + updateTime + ", createTimeStart=" + createTimeStart + ", createTimeEnd="
