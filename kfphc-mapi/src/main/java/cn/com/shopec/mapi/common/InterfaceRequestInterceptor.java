...
public class InterfaceRequestInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest req, HttpServletResponse res, Object handler) throws Exception {
		...
		if(Constant.CHECK_SWITCH_ON.equals(checkSwitch)){
			...
			if(token!=null&&!"".equals(token)){
				...
				if(tokenExpDateDays!=null){
					Date failureDate = ECDateUtils.getDateAfter(member.getTokenGenerateTime(), Integer.parseInt(tokenExpDateDays));
		...
		ConcurrentHashMap<String, String> uriMap = (ConcurrentHashMap<String, String>)context.getAttribute("interceptorURIMap");
		//存放要处理请求路径
		ConcurrentHashMap<String, String> requestURIMap = (ConcurrentHashMap<String, String>)context.getAttribute("requestURIMap");
		for (String key:uriMap.keySet()) {
			...
			if(uriValue.equals(requestURI)){
				...
				//微信支付
					...
					String wxpayURI = "wxpayURI"+req.getParameter("payNo")+"_"+req.getParameter("memberNo")+"_"+req.getParameter("packageNo")+"_"+req.getParameter("type")+"_"+req.getParameter("tag");
					String value = requestURIMap.get(wxpayURI);
					if(value==null){
						requestURIMap.put(wxpayURI, req.getParameter("payNo")+"_"+req.getParameter("memberNo")+"_"+req.getParameter("packageNo")+"_"+req.getParameter("type")+"_"+req.getParameter("tag"));
					}else{
						res.sendRedirect(errorInfoPath+"?type=4");
						return false;
					}
				//支付宝支付
					...
					String alipayURI = "alipayURI"+req.getParameter("payNo")+"_"+req.getParameter("memberNo")+"_"+req.getParameter("packageNo")+"_"+req.getParameter("type")+"_"+req.getParameter("tag");
					String value = requestURIMap.get(alipayURI);
					if(value==null){
						requestURIMap.put(alipayURI, req.getParameter("payNo")+"_"+req.getParameter("memberNo")+"_"+req.getParameter("packageNo")+"_"+req.getParameter("type")+"_"+req.getParameter("tag"));
					}else{
						res.sendRedirect(errorInfoPath+"?type=4");
						return false;
					}
		...
		for (String key:uriMap.keySet()) {
			...
			if(uriValue.equals(requestURI)){
				...
				//微信支付
					...
					String wxpayURI = "wxpayURI"+request.getParameter("payNo")+"_"+request.getParameter("memberNo")+"_"+request.getParameter("packageNo")+"_"+request.getParameter("type")+"_"+request.getParameter("tag");
					String value = requestURIMap.get(wxpayURI);
					if(value!=null){
				...
				//支付宝支付
					...
					String alipayURI = "alipayURI"+request.getParameter("payNo")+"_"+request.getParameter("memberNo")+"_"+request.getParameter("packageNo")+"_"+request.getParameter("type")+"_"+request.getParameter("tag");
					String value = requestURIMap.get(alipayURI);
					if(value!=null){
