...
<html>
  <head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
     ...
     <link href="res/css/login/gray_login.css" rel="stylesheet" type="text/css" />
...
<div class="login_m">
	<div class="login_logo">
		<!--<img src="res/img/images/gif-5-1-1.png" >-->
		<img src="res/img/xzlogo.png" style="width:78%;height:78%;" >
	</div>
	...
	<div class="login_boder">
		<form action="login.do" method="post">
			<div class="login_padding">
				<h2>用户名</h2>
				<label>
					<input type="text" id="loginName" name="loginName" class="txt_input txt_input2" onfocus="if (value ==&#39;Your name&#39;){value =&#39;&#39;}" onblur="if (value ==&#39;&#39;){value=&#39;Your name&#39;}" value="">
				</label>
				<h2>密码</h2>
				<label>
					<input type="password" name="loginPassword" id="loginPassword" class="txt_input" onfocus="if (value ==&#39;******&#39;){value =&#39;&#39;}" onblur="if (value ==&#39;&#39;){value=&#39;******&#39;}" value="">
				</label>
				<div class="rem_sub">
					<label>
...
<br />
<div class="footer">
	<p align="center">﻿ 法律说明 粤ICP备14070354号-1 本网站已经申请网络设计版权认证，盗版必究。 Copyright 2016 <a href="http://www.shopec.com.cn/" target="_blank" title="行知网络">行知网络</a> 版权所有  </p>
</div>
