...
public class MemberPointsRuleController extends BaseController {
	...
	@ResponseBody
	public PageFinder<MemberPointsRule> pageListMemberPointsRule(
			@ModelAttribute("memberPointsRule") MemberPointsRule memberPointsRule, @RequestParam("pageNo") int pageNo,
	...
	@ResponseBody
	public ResultInfo<MemberPointsRule> addMemberPointsRule(
			@ModelAttribute("memberPointsRule") MemberPointsRule memberPointsRule) {
	...
	@ResponseBody
	public ResultInfo<MemberPointsRule> updateMemberPointsRule(
			@ModelAttribute("memberPointsRule") MemberPointsRule memberPointsRule) {
