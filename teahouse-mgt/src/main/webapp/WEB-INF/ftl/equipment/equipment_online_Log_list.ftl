...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12 pd10">
			...
			<div class="box box-default">
				...
				<form class="form-horizontal" name="fitnessEquipmentLogSerachForm">
				<input type="hidden" name="fitnessEquipmentNo" value="${fitnessEquipmentNo}"/>
					<div class="box-body">
						<div class="row pull-down-menu col-md-11">
							<div class="col-md-4">
								<div class="frombg">
									<span>操作类型</span><select class="form-control"
										name="opType">
	...
	<div class="row">
		<div class="col-xs-12">
			<!--定义操作列按钮模板-->
			<script id="fitnessEquipmentLogBtnTpl" type="text/x-handlebars-template">
        {{#each func}}
        <button type="button" class="btn btn-{{this.type}} btn-sm" onclick="{{this.fn}}">{{this.name}}</button>
  		{{/each}}
			...
			<div class="box">
				<div class="box-body">
					<table id="fitnessEquipmentLogList" class="table table-hover"
						width="100%" border="1">
					</table>
				</div>
				<!-- /.box-body -->
...
<script type="text/javascript">
    $(function(){
	  require.config({paths: {"fitnessEquipmentLog":"res/js/equipment/equipment_online_Log_list"}});
		require(["fitnessEquipmentLog"], function (fitnessEquipmentLog){
			fitnessEquipmentLog.init();
		});  
	});
</script>