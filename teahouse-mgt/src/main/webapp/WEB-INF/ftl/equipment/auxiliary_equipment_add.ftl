...
<div class="container-fluid">
                <div class="row">
					<div class="col-md-12">
						<div class="form-group compiletitle">
							<label class="col-sm-12 control-label"><h4>辅助设备新增</h4></label>
						</div>
					</div>
				</div>	       
				<div class="row hzlist">
					...
					<form name="auxiliaryEquipmentAddForm">
						...
						<div class="form-group col-md-6">
							...
							<div class="col-sm-6" id="storeModelN1">
                ...
                <div class="form-group">
                    <div class="col-sm-6" style="margin-bottom:20px;">
                        <button type="button" id="closeAddAuxiliaryEquipment" class="btn btn-default pull-right sure btncolorb" style="width: 95px; height: 32px; line-height: 25px; background:#fa6e30; margin-right: 50px !important">
                             	 关闭
                        </button>
...
<script type="text/javascript">
	$(function(){
	  require.config({paths: {"auxiliaryEquipmentAdd":"res/js/equipment/auxiliary_equipment_add"}});
		require(["auxiliaryEquipmentAdd"], function (auxiliaryEquipmentAdd){
			auxiliaryEquipmentAdd.init();
		});
	});
</script>
</body>
