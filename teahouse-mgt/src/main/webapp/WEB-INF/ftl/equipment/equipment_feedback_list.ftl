...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12 pd10">
			...
			<div class="box box-default">
				...
				<form class="form-horizontal" name="equipmentFeedbackSerachForm">
					<div class="box-body">
						<div class="row pull-down-menu col-md-11">
							<div class="col-md-4">
								<div class="frombg">
									<span>会员名称</span><input type="text" class="form-control"
							...
							<div class="col-md-4">
								<div class="frombg">
									<span>报修类型</span>
									<select class="form-control" name="feedbackId">
	...
	<div class="row">
		<div class="col-xs-12">
			<!--定义操作列按钮模板-->
			<script id="equipmentFeedbackBtnTpl" type="text/x-handlebars-template">
        {{#each func}}
        <button type="button" class="btn btn-{{this.type}} btn-sm" onclick="{{this.fn}}">{{this.name}}</button>
  		{{/each}}
			...
			<div class="box">
				<div class="box-body">
					<table id="equipmentFeedbackList" class="table table-hover"
						width="100%" border="1">
					</table>
				</div>
				<!-- /.box-body -->
...
<script type="text/javascript">
    $(function(){
	  require.config({paths: {"equipmentFeedback":"res/js/equipment/equipment_feedback_list"}});
		require(["equipmentFeedback"], function (equipmentFeedback){
			equipmentFeedback.init();
		});  
	});
</script>
