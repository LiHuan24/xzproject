      ...
      <div class="col-md-12 pd10">
       ...
       <div class="box box-default">
        ...
        <div class="box-body">
         ...
         <div class="col-md-6">
                <div class="frombg">
                    <span>数据字典分类名称</span><input type="text" class="form-control" name="dataDictCatName" placeholder="">
                </div>
         </div>
         <div class="col-md-6">
                <div class="frombg">
 ...
 <!--修改-->
          <div class="col-md-12" style='float:right !important;'>
               <div class="box-footer">
                 <button type="button" class="btn btn-default pull-right btn-flat flatten btnColorA" id="dataDictSearchButton" style="background:#2b94fd;margin-right:-2px !important">确定</button>
