        ...
        <!-- /.box-tools -->
         ...
         <div class="box-body">
	         <div class="row pull-down-menu col-md-11">
	          <div class="col-md-4">
	                <div class="frombg">
                        <span>用户账号</span><input type="text" class="form-control" name="userName" placeholder="">
                    </div>
	          </div>
	          <div class="col-md-4">
	                <div class="frombg">
                        <span>用户名称</span><input type="text" class="form-control" name="realName" placeholder="">
                    </div>
	          </div>
	         <div class="col-md-4">
	               <div class="frombg">
             ...
             <div class="col-md-12" style='float:right'>
                    <div class="box-footer">
                     <!-- <button type="submit" class="btn btn-default pull-right">Cancel</button> -->
                      ...
                      <button type="button" class="btn btn-default pull-right btn-flat flatten btnColorA" id="sysUserSearchafter" style="margin-right:-2px !important">确定</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" name="sysUserForm">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" maxlength="30" class="form-control val" id="formUserName" name="userName" placeholder="" required="required">
                            </div>
                        </div>
                        <div class="form-group" id="divPassword1">
                            ...
                            <div class="col-sm-8">
                                <input type="password" maxlength="20" class="form-control val" id="formPassword1" name="password1" placeholder="">
                            </div>
                        </div>
                        <div class="form-group" id="divPassword2">
                            ...
                            <div class="col-sm-8">
                                <input type="password" maxlength="20" class="form-control val" id="formPassword2" name="password2" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" maxlength="16" class="form-control val" id="formRealName" name="realName" placeholder="">
                            </div>
                        </div>
                         <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3 control-label key">email：<span style="color: red;">*</span></label>
                            <div class="col-sm-8">
                                <input type="email" class="form-control val" id="formEmail" name="email" placeholder="Email">
                            </div>
                        </div>  
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3 control-label key">手机：<span style="color: red;">*</span></label>
                            <div class="col-sm-8">
                                <input type="tel" class="form-control val" id="formMobilePhone" name="mobilePhone" placeholder="">
                            </div>
                        </div>   
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3 control-label key">电话：</label>
                            <div class="col-sm-8">
                                <input type="tel" class="form-control val" id="formTelPhone" name="telPhone" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3 control-label key">备注：</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control val" id="sysUserformMemo" name="memo" placeholder="">
                            </div>
                        </div>                       
                        <div class="form-group">
                    ...
                    <button type="button" style="width: 95px; height: 32px; line-height: 25px; background:#fa6e30; margin-right: 50px !important" class="btn btn-default pull-right btncolorb"  id="sysUserResetBtn">重置</button>
                     <button type="button" style="width: 95px; height: 32px; line-height: 25px; background:#2b94fd;" class="btn btn-default pull-right btncolora"  id="sysUserEditBtn">保存</button>
