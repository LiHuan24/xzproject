   ...
   <div class="container-fluid">
        ...
        <div class="with-border">
         ...
         <!-- /.box-tools -->
            <div class="row pull-down-menu col-md-11" style="margin-left: 1px; background: #f1f5f8;">
                <div class="col-md-3">
                    <div class="frombg">
                        <span>编号</span><input type="text" class="form-control"  name="parkingSpaceNo" placeholder="">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="frombg">
                        <span>城市</span><select name="cityId" class="form-control">
                ...
                <div class="col-md-3">
                    <div class="frombg">
                        <span>所属</span><select class="form-control" name="ownerType">
                        <option value="">全部</option>
                   ...
                   <div class="col-md-12" style='float:right;'>
                      <div class="box-footer">
                          <!-- <button type="submit" class="btn btn-default pull-right">Cancel</button> -->
                            ...
                            <button type="button" class="btn btn-default pull-right btn-flat flatten btncolora btnColorA" id="parkingSpaceSearchafter" style="background:#2b94fd;margin-right:-2px !important">
                                                          确定
                            </button>
                            <button type="reset" class="btn btn-default pull-right btn-flat flatten btncolorb btnDefault" style="background:#fa6e30;float:right;margin-right:20px !important">
                                                                                      清空
                              </button>
                       </div>
                 </div>
     ...
     <div class="row">
      <div class="col-xs-12">
       ...
       <div class="box">
        <div class="box-body">
         <table id="parkingSpaceList" class="table table-hover" width="100%" border="1">
         </table>
        </div><!-- /.box-body -->
       </div><!-- /.box -->
      </div>
