...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12 pd10">
			...
			<div class="box box-default">
				...
				<form class="form-horizontal" name="courseLabelSerachForm">
					<div class="box-body">
						<div class="row pull-down-menu col-md-11">
							<div class="col-md-4">
								<div class="frombg">
									<span>课程标签名称</span><input type="text" class="form-control"
										name="labelName" placeholder="">
								</div>
							</div>
						</div>
						<!-- /.box-body -->
	...
	<div class="row">
		<div class="col-xs-12">
			<!--定义操作列按钮模板-->
			<script id="courseLabelBtnTpl" type="text/x-handlebars-template">
        {{#each func}}
        <button type="button" class="btn btn-{{this.type}} btn-sm" onclick="{{this.fn}}">{{this.name}}</button>
  		{{/each}}
			...
			<div class="box">
				<div class="box-body">
					<table id="courseLabelList" class="table table-hover"
						width="100%" border="1">
					</table>
				</div>
				<!-- /.box-body -->
...
<script type="text/javascript">
    $(function(){
	  require.config({paths: {"courseLabel":"res/js/themepavilion/course_label_list"}});
		require(["courseLabel"], function (courseLabel){
			courseLabel.init();
		});  
	});
</script>
