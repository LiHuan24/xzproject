  		...
  		{{/each}}
			...
			<div class="box">
				<div class="box-body">
					...
					<button type="button" id="addTemplateTr"
...
<!-- /.container-fluid -->
<!-- 选择时间层 -->
<div class="modal fade"  id="dateDivModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
			      ...
			      <div class="modal-footer">
                     <button type="button" class="btn btn-default pull-right sure" id="selectDateSub" >确定</button>
    ...
    <!-- 编辑排课时间弹出层 -->
    <div class="modal fade"  id="editDateDivModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body">
			      ...
			      <div class="modal-footer">
                     <button type="button" class="btn btn-default pull-right sure" id="editDateSub" >确定</button>
                     <button type="button" class="btn btn-default pull-right cancels"  id="cancelEditBtn">取消</button>
                </div> 
                </div>
    ...
    <!-- 编辑课程和教练、人数谈弹出层 -->
        <div class="modal fade"  id="editCourseAndCoachModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body">
			         ...
			         <div class="form-group">
                       <div class="col-sm-6">
                          ...
                          <input class="form-control" name="chineseName" value="" style="background:#FFFFFF" readonly/>
                             <button type="button" id="selectEditCourse" class="btn btn-default pull-left sure btncolora" style="width: 95px; height: 32px; line-height: 25px; background: #2b94fd;">
						选择课程
						</button>
                          </div>
                      </div>
			          ...
			          <div class="form-group">
                         ...
                         <input id="coachNo" name="coachNo" type="hidden" value=""/>  
                              ...
                              <button type="button" id="selectEditCoach" class="btn btn-default pull-left sure btncolora" style="width: 95px; height: 32px; line-height: 25px; background: #2b94fd;">
								选择教练
								</button>
                         </div>
                      </div>
			      ...
			      <div class="modal-footer">
                    	<button type="button" class="btn btn-default pull-right sure" id="editCourseBtn">提交</button>
                     	<button type="button" class="btn btn-default pull-right cancels"  id="cancelEditCourseBtn">取消</button>
                </div> 
                </div>
    ...
    <!-- 排课选择课程和教练层 -->
    <div class="modal fade"  id="courseAndCoachModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body">
			         ...
			         <div class="form-group">
                       <div class="col-sm-6">
                          ...
                          <input class="form-control" name="chineseName" style="background:#FFFFFF" readonly/>
                             <button type="button" id="selectCourse" class="btn btn-default pull-left sure btncolora" style="width: 95px; height: 32px; line-height: 25px; background: #2b94fd;">
						选择课程
						</button>
                          </div>
                      </div>
			          ...
			          <div class="form-group">
                         ...
                         <input id="coachNo" name="coachNo" type="hidden" value=""/>  
                              ...
                              <button type="button" id="selectCoach" class="btn btn-default pull-left sure btncolora" style="width: 95px; height: 32px; line-height: 25px; background: #2b94fd;">
								选择教练
								</button>
                         </div>
                      </div>
			      ...
			      <div class="modal-footer">
                    	<button type="button" class="btn btn-default pull-right sure" id="onFormBtn">提交</button>
                     	<button type="button" class="btn btn-default pull-right cancels"  id="cancelCourseBtn">取消</button>
                </div> 
                </div>
  ...
  <!-- 课程列表层 -->
  <div class="modal" id="courselistModal">
	<div class="modal-dialog" style="width:750px;">
	       ...
	       <div class="col-xs-14">
		       ...
		       <div class="box">
			        ...
			        <div class="box-body">
			         <table id="courseListAdd" class="table table-bordered table-striped table-hover" width="100%">
			         </table>
			        </div><!-- /.box-body -->
		   </div><!-- /.box -->
		</div><!-- /.modal-content -->
...
<!-- 教练列表层 -->
  <div class="modal" id="coachlistModal">
	<div class="modal-dialog" style="width:750px;">
	   	<div class="modal-content">
	   	<form name="courseAndCoachForm">
		      <div class="with-border">
	       ...
	       <div class="col-xs-14">
		       ...
		       <div class="box">
			        ...
			        <div class="box-body">
			         <table id="coachListAdd" class="table table-bordered table-striped table-hover" width="100%">
			         </table>
			        </div><!-- /.box-body -->
		   </div><!-- /.box -->
		</div><!-- /.modal-content -->
...
<!-- 编辑 -->
<div class="modal" id="courseEditListModal">
	<div class="modal-dialog" style="width:750px;">
	   	<div class="modal-content">
	       ...
	       <div class="col-xs-14">
		       <!--定义操作列按钮模板-->
		       <script id="courseBtnTplEdit" type="text/x-handlebars-template">
		        {{#each func}}
		        <button type="button" class="btn btn-{{this.type}} btn-sm" onclick="{{this.fn}}">{{this.name}}</button>
		        {{/each}}
		       </script>
		       <div class="box">
			        ...
			        <div class="box-body">
			         <table id="courseListEdit" class="table table-bordered table-striped table-hover" width="100%">
			         </table>
			        </div><!-- /.box-body -->
		   </div><!-- /.box -->
		</div><!-- /.modal-content -->
...
<!-- 教练列表层 -->
  <div class="modal" id="coachEditListModal">
	<div class="modal-dialog" style="width:750px;">
	   	<div class="modal-content">
	       ...
	       <div class="col-xs-14">
		       ...
		       <div class="box">
			        ...
			        <div class="box-body">
			         <table id="coachListEdit" class="table table-bordered table-striped table-hover" width="100%">
			         </table>
			        </div><!-- /.box-body -->
		   </div><!-- /.box -->
		</div><!-- /.modal-content -->
...
$(function(){
	 require.config({paths: {"templateCourse":"res/js/themepavilion/template_course_list"}});
		require(["templateCourse"], function (templateCourse){
			templateCourse.init();
		});
		//closeTab("查询");
