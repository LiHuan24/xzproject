...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12 pd10">
			...
			<div class="box box-default">
				...
				<form class="form-horizontal" name="courseSortSerachForm">
					<div class="box-body">
						<div class="row pull-down-menu col-md-11">
							<div class="col-md-4">
								<div class="frombg">
									<span>课程分类名称</span><input type="text" class="form-control"
										name="sortName" placeholder="">
								</div>
							</div>
						</div>
						<!-- /.box-body -->
	...
	<div class="row">
		<div class="col-xs-12">
			<!--定义操作列按钮模板-->
			<script id="courseSortBtnTpl" type="text/x-handlebars-template">
        {{#each func}}
        <button type="button" class="btn btn-{{this.type}} btn-sm" onclick="{{this.fn}}">{{this.name}}</button>
  		{{/each}}
			...
			<div class="box">
				<div class="box-body">
					<table id="courseSortList" class="table table-hover"
						width="100%" border="1">
					</table>
				</div>
				<!-- /.box-body -->
...
<script type="text/javascript">
    $(function(){
	  require.config({paths: {"courseSort":"res/js/themepavilion/course_sort_list"}});
		require(["courseSort"], function (courseSort){
			courseSort.init();
		});  
	});
</script>