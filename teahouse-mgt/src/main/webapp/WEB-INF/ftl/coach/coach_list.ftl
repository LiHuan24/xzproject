...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12 pd10">
			...
			<div class="box box-default">
				...
				<form class="form-horizontal" name="coachSerachForm">
					<div class="box-body">
	...
	<div class="row">
		<div class="col-xs-12">
			<!--定义操作列按钮模板-->
			<script id="coachBtnTpl" type="text/x-handlebars-template">
        {{#each func}}
        <button type="button" class="btn btn-{{this.type}} btn-sm" onclick="{{this.fn}}">{{this.name}}</button>
  		{{/each}}
			...
			<div class="box">
				<div class="box-body">
					<table id="coachList" class="table table-hover"
						width="100%" border="1">
					</table>
				</div>
				<!-- /.box-body -->
...
<script type="text/javascript">
    $(function(){
	  require.config({paths: {"coachList":"res/js/coach/coach_list"}});
		require(["coachList"], function (coachList){
			coachList.init();
		});  
	});
</script>