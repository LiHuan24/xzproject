...
<div class="container-fluid">
                <div class="row">
					<div class="col-md-12">
						<div class="form-group compiletitle">
							<label class="col-sm-12 control-label"><h4>教练审核</h4></label>
						</div>
					</div>
				</div>	       
				<div class="row hzlist">
					<div class="col-md-12">
					<form name="coachAuditForm">
					...
					<div class="col-md-12">
						<div class="form-group col-md-6"> 
               				<label class="col-sm-4 control-label key">&nbsp;&nbsp;审核认证状态：</label>
			                 <div class="col-sm-7">
		                     <input name="censorStatus" type="radio" value="1" <#if (coach.censorStatus == 1)>checked="checked"</#if>/>审核通过
		                     <input name="censorStatus" type="radio" value="2" <#if (coach.censorStatus == 2)>checked="checked"</#if>/>待审核
		                     <input name="censorStatus" type="radio" value="3" <#if (coach.censorStatus == 3)>checked="checked"</#if>/>审核不通过
			                 </div>
		             	</div>
		             	<div><span name="censorStatusAudit"></span></div>
					</div>	
					<div class="col-md-12">
						<div class="form-group col-md-6"> 
               				<label class="col-sm-4 control-label key">&nbsp;&nbsp;审核备注：</label>
			                 <div class="col-sm-7">
		                     	 <textarea class="form-control val" name="cencorMemo" style="width: 300px;height: 100px;">
								 ${coach.cencorMemo}
								 </textarea>
			                 </div>
		             	</div>
		             	<div><span name="cencorMemoAudit"></span></div>
					</div>	
					<div class="col-md-12">
                ...
                <div class="form-group">
                    <div class="col-sm-6" style="margin-bottom:20px;">
                        <button type="button" id="closeAuditCoach" class="btn btn-default pull-right sure btncolorb" style="width: 95px; height: 32px; line-height: 25px; background:#fa6e30; margin-right: 50px !important">
                             	 关闭
                        </button>
                        <button type="button" id="auditCoach" class="btn btn-default pull-right sure btncolora" style="width: 95px; height: 32px; line-height: 25px; background:#2b94fd;">
                              	提交
                        </button>
                    </div>
                </div>
...
<script type="text/javascript">
	$(function(){
	  require.config({paths: {"coachAudit":"res/js/coach/coach_audit"}});
		require(["coachAudit"], function (coachAudit){
			coachAudit.init();
		});
