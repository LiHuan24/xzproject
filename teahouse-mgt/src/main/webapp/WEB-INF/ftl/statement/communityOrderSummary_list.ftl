...
border:1px solid rgba(127,127,127,0.05);
   ...
   <div class="container-fluid">
     <div class="row">
      <div class="col-md-12 pd10">
       ...
       <div class="box box-default">
           <form class="form-horizontal" name="communityOrderSummarySearchForm">
                 ...
                 $(document).ready(function(){
                  ...
                  <div class="col-md-12" style='float:right'>
                         <div class="box-footer">
							<button type="button" class="btn btn-default pull-right btn-flat flatten btnColorA" id="communityOrderSummarySearchafter" style="background:#2b94fd;margin-right:-2px !important">
								确定
  							</button>
     ...
     <div class="row">
      <div class="col-xs-12">
       <!--定义操作列按钮模板-->
       <script id="communityOrderSummaryTpl" type="text/x-handlebars-template">
        {{#each func}}
       ...
       <div class="box">
        <div class="box-body">
         <table id="communityOrderSummaryList" class="table table-hover" width="100%" border="1">
         </table>
        </div><!-- /.box-body -->
       </div><!-- /.box -->
      </div>
    ...
    $(function(){
    require.config({paths: {"communityOrderSummary":"res/js/statement/communityOrderSummary_list"}});
		require(["communityOrderSummary"], function (communityOrderSummary){
			communityOrderSummary.init();
		});
