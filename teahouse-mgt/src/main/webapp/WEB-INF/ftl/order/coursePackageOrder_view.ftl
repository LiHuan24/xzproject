...
<div class="container-fluid">
				...
				<div class="row hzlist">
					<div class="col-md-12 form-horizontal">
						...
						<div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
					  		<!-- Nav tabs -->
					  		<ul id="coursePackageOrderViewTabs" class="nav nav-tabs">
						    	<li class="active"><a href="#baseTab" aria-controls="baseTab" role="tab" data-toggle="tab">基础信息</a></li>
						    	<li><a href="#costTab" aria-controls="costTab" role="tab" data-toggle="tab">课程包信息</a></li>
 ...
 -->					 	</ul>    
									...
									<div class="col-md-12 form-horizontal">
										...
										<div class="form-group col-md-6">
											...
											<label class="control-label val">
											   ${coursePackageOrder.rechargeOrderNo}
			       								<input type="hidden"  name="coursePackageOrderNo" value="${coursePackageOrder.rechargeOrderNo}">
											   </label>
											</div>
										</div>
										<div class="form-group col-md-6">
										...
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
											      ${coursePackageOrder.mobilePhone}
											       </label>
											</div>
										</div>
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
											${coursePackageOrder.coursePackageName}
											</label>
											</div>
										</div>
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
											${coursePackageOrder.payableAmount}
											</label>
											</div>
										</div>
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
												<#if coursePackageOrder.payStatus==0>
													未支付
												<#elseif coursePackageOrder.payStatus==1>
					                				已支付
					                			<#elseif coursePackageOrder.payStatus==2>
					                				部分支付
					                			<#else>
					                			</#if>
											</label>
						     	...
						     	<div class="tab-pane" id="costTab">
									<div class="col-md-12 form-horizontal">
										...
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
												${coursePackageOrder.coursePackageNo}
											</label>
											</div>
										</div>
										<div class="form-group col-md-6">
										...
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
												<#if coursePackageOrder.payableAmount??>
													${coursePackageOrder.payableAmount?string(',###.##')}元
												</#if>
											</label>
											</div>
										</div>	
								 ...
								 <div class="tab-pane" id="payTab">
									<div class="col-md-12 form-horizontal">
										...
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
											<#if coursePackageOrder.createTime??>
											${coursePackageOrder.createTime?string('yyyy-MM-dd HH:mm:ss')}
											</#if>
											</label>	
											</div>
										</div>
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
											    <#if coursePackageOrder.paymentMethod==1>
													支付宝
												<#elseif coursePackageOrder.paymentMethod==2>
					                				微信
					                			<#elseif coursePackageOrder.paymentMethod==3>
					                				银行卡转账
					                			<#else>
					                				其他
					                			</#if>
										...
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
											${coursePackageOrder.partTradeFlowNo}
											</label>
											</div>
										</div>
									</div>
						    	...
						    	<div class="tab-pane" id="billingTab">
									<div class="col-md-12 form-horizontal">
										...
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
											<#if coursePackageOrder.invoiceTime??>
											${coursePackageOrder.invoiceTime?string('yyyy-MM-dd HH:mm:ss')}
											<#else>
											无
											</#if>
											</label>
										...
										<div class="form-group col-md-6">
											...
											<div class="col-sm-6">
											<label class="control-label val">
											<#if coursePackageOrder.invioceNo!="">
												${coursePackageOrder.invioceNo}
											<#else>
											无
											</#if>
											</label>
	...
	<div class="form-group">
        <div class="col-sm-7">
            <button id="coursePackageOrderViewClose" class="btn btn-default pull-right navbar-btn btn-flat member-operate-save btnDefault" style="width: 95px; height: 32px; line-height: 25px; padding-left: 15px; background: #2b94fd">
                    	关闭
            </button>
        </div>
    </div>
...
<script type="text/javascript">
    $(function () {
     require.config({paths: {"coursePackageOrderView":"res/js/order/coursePackageOrder_view"}});
		require(["coursePackageOrderView"], function (coursePackageOrderView){
			coursePackageOrderView.init();
		});  
