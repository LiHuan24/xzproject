...
<html>
  <head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
     ...
     <link href="res/css/login/login.css" rel="stylesheet" type="text/css" />
  ...
  <body class="hold-transition login-page" >
		<div class="box">
		    ...
		    <div class="m-2">
		          <div class="m-2-1">
		            <form action="login.do" method="post">
		                <div class="m-2-2">
		                   <input type="text" placeholder="text" name="loginName" value="admin">
		                </div>
		                <div class="m-2-2">
		                   <input type="password" placeholder="Password" name="loginPassword" value="123456">
		                </div>
		                <div class="m-2-2">
		    ...
		    <div class="m-x20"></div>  
		    <div class="m-8"></div>
		    <div class="m-9"><div class="masked1" id="sx8">行知网络分时管理平台</div></div> 
		    <div class="m-11">
		...
		<script src="res/js/login/common.min.js"></script>
