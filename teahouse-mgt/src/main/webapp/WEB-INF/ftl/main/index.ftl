...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=XWlUgpVK4cGkZjyBSoyNTM8wEV1T0qgN"></script>
 <!-- 加载高德地图样式信息 -->
 <script type="text/javascript" src="https://webapi.amap.com/maps?v=1.3&key=a51101a73a84e91a6cc0f86b85d98573"></script>
 <!-- datepicker -->
...
<div class="wrapper">
 ...
 <input type="hidden" id="appModel">
  ...
  <a href="#" class="logo">
   ...
   <span class="logo-lg"><!-- <img src="res/img/images/gif-5-1-1.png" style="width:40px;height:40px; margin-right:4px;"> --><b>共享健身房系统</b></span>
  </a>
          ...
          <div class="container-fluid containerBg">
          	<div class="row blList">
                	 ...
                	 .blList{
                	 	...
                	 	height: 500px;
                	 	/* background: #3f9fff; */
                	 	background:url(res/img/home.jpg);
                	 }
                	 .search{
                	 	width: 100%;
                	 	margin: 20px 0;
...
<script type="text/x-handlebars-template" id="upload-item-template">
 ...
 <footer class="main-footer">
  ...
  <!-- Default to the left -->
  Copyright &copy; 2017 <a href="http://www.shopec.com.cn" style="color: #8899aa">深圳市行知网络科技有限公司</a>. All rights reserved.
 </footer>
<!-- ./wrapper -->
<!-- [if lt IE 9] -->
<!-- jQuery 2.1.4 -->
