   ...
   <div class="container-fluid">
       ...
       <div class="box box-default">
        ...
        <div class="with-border">
            ...
            <div class="row pull-down-menu col-md-11" style="margin-left: 1px; background: #f1f5f8;">
                <div class="col-md-3">
                    <div class="frombg">
                        <span>优惠券号</span><input type="text" class="form-control" name="couponNo" placeholder="">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="frombg">
                        <span>方案标题</span><input type="text" class="form-control" name="title" placeholder="">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="frombg">
                 ...
                 <div class="col-md-3">
                    <div class="frombg">
                        <span>手机</span><input type="text" class="form-control" name="mobilePhone" placeholder="">
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="box-body">
         ...
         <div class="box-body">
           ...
           <div class="col-md-3">
                  <div class="frombg">
                      <span>发放日期</span><input class="datepicker form-control" name="issueTimeStart" placeholder=""/>
                  </div>
            </div>
            <div class="col-md-3">
                 <div class="frombg">
                     <span>至</span> <input class="datepicker form-control" name="issueTimeEnd" placeholder=""/>
                 </div>
           </div>
          </div>
                 ...
                 $(document).ready(function(){
                  ...
                  <div class="col-md-12" style='float:right'>
                         <div class="box-footer">
                                 ...
                                 <button type="button" class="btn btn-default pull-right btn-flat flatten btnColorA" id="couponSearchafter" style="background:#2b94fd;margin-right:-2px !important">
                                                          确定
                                 </button>
     ...
     <div class="row">
      <div class="col-xs-12">
       ...
       <div class="box">
        <div class="box-body">
         <table id="couponList" class="table table-hover" width="100%" border="1">
         </table>
        </div><!-- /.box-body -->
       </div><!-- /.box -->
      </div>
