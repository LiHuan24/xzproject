   ...
   <div class="container-fluid">
       ...
       <div class="box box-default">
        ...
        <div class="with-border">
            ...
            <div class="row pull-down-menu col-md-11" style="margin-left: 1px; background: #f1f5f8;">
                ...
                <div class="col-md-3">
                    <div class="frombg">
                        <span>推送方式</span><select class="form-control" name="pushPattern">
                ...
                <div class="col-md-3">
                    <div class="frombg">
                        <span>会员姓名</span><input type="text" class="form-control" name="memberName" placeholder="">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="frombg">
        ...
        <div class="box-body">
          ...
          <div class="col-md-3">
                  <div class="frombg">
                      <span>推送时间</span><input class="datepicker form-control" name="pushTimeStart" placeholder=""/>
                  </div>
            </div>
            <div class="col-md-3">
                 <div class="frombg">
                     <span>至</span> <input class="datepicker form-control" name="pushTimeEnd" placeholder=""/>
                 </div>
           </div>
         </div>
         <div class="row">
               ...
               <script>
                  ...
                  <div class="col-md-12" style='float:right'>
                         <div class="box-footer">
                              ...
                              <button type="button" class="btn btn-default pull-right btn-flat flatten btnColorA" id="messagePushSearchafter" style="background:#2b94fd;margin-right:-2px !important">
                                                         确定
                              </button>
     ...
     <div class="row">
      <div class="col-xs-12">
       ...
       <div class="box">
        <div class="box-body">
         <table id="messagePushList" class="table table-hover" width="100%" border="1">
         </table>
        </div><!-- /.box-body -->
       </div><!-- /.box -->
      </div>
