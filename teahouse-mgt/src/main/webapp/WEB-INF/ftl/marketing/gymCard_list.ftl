      ...
      <div class="col-md-12 pd10">
         ...
         <!-- /.box-tools -->
       	<div class="box box-default">
			<form class="form-horizontal" name="gymCardSerachForm">
	        <div class="with-border">
	
	            <div class="row pull-down-menu col-md-11">
	                <div class="col-md-3">
	                    <div class="frombg">
	                  		<span>健身卡编号</span><input  class="form-control" name="gymCardNo" placeholder="">
	                    </div>
	                </div>
	                <div class="col-md-3">
	                    <div class="frombg">
	                 		<span>健身卡名称</span><input class="form-control" name="gymCardName" placeholder="">
	                    </div>
	                </div>
	                 <div class="col-md-3">
	                    <div class="frombg">
			...
			<div class="col-md-12" style='float:right'>
		      	<div class="box-footer">
		      		<button type="button" class="btn btn-default pull-right btn-flat flatten btnColorA" id="gymCardSearch"  style="background:#2b94fd;margin-right:-2px !important">
						确定
					</button>
...
<div class="row" style="width: 100%; height: 2px; background: #f1f5f8"></div>
	<div class="row">
		<div class="col-xs-12">
			<!--定义操作列按钮模板-->
			<script id="gymCardTpl" type="text/x-handlebars-template">
        		{{#each func}}
	       	...
	       	<div class="box">
				<div class="box-body">
		         	<table id="gymCardList" class="table table-hover" width="100%" border="1">
					</table>
				</div><!-- /.box-body -->
			</div><!-- /.box -->
      </div>
...
<div class="modal fade" id="gymCardCencorModel">
	<div class="modal-dialog">
	    <div class="modal-content">
	        ...
	        <div class="modal-body">
				<form class="form-horizontal" name="gymCardCencorForm"> 
		  			<input type="hidden"  name="gymCardNo" id="gymCardCencorNo">
		    		<label for="inputEmail3" class=" control-label wen" id="gymCardCencorMemo"></label>
		      		<div>
					...
					<div class="form-group">
			       	...
			       	<div class="modal-footer">
	                    <input type="button" class="btn btn-default pull-right sure" id="gymCardCencorBtn" value="确定">
	                    <button type="button" class="btn btn-default pull-right cancels" id="gymCardCencorCancel">取消</button>
	                </div>              
				</form> 
	         </div>
	     </div><!-- /.modal-content -->
