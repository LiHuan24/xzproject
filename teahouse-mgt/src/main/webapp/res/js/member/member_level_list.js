					...
					var table = $('#memberLevelList').dataTable(
						{
										...
										{"title" : "晋升所需积分","data" : "upgradePoint"},
										{"title" : "是否可用","data" : "isAvailable"},
										{"title" : "创建时间","data" : "createTime"},
										{"title" : "操作","orderable" : false} 
										],
										"dom" : "<'row'<'#memberLeveltool.col-xs-6'><'col-xs-6'f>r>"
												+ "t"
												+ "<'row'<'col-xs-3'l><'col-xs-3'i><'col-xs-6'p>>",
										initComplete : function() {
											$("#memberLeveltool").html("");
											$("#memberLeveltool").css("float", "right");
											$("#memberLeveltool").removeClass("col-xs-6");
											$("#memberLeveltool").append('<button type="button" class="btn btn-default btn-sm memberLeveltool-operate-add btnDefault" style="width: 95px; height: 32px; line-height: 25px; -webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px; background-color: #2b94fd">新增</button>');
