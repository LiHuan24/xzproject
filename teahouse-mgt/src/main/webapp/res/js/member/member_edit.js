	...
	init : function() {
		...
		$("#addMemberPhotoBtn").click(function(){
			...
			if(img!=""){
				...
				form1.find("img[name=memberPhotoUrlImg]").attr("src",memberEdit.imgPath+"/"+img);
		...
		$("#addDriverLicensePhotoUrl1Btn").click(function(){
			...
			if(img!=""){
				...
				form1.find("img[name=driverLicensePhotoUrl1Img]").attr("src",memberEdit.imgPath+"/"+img);
		...
		$("#addidCardPhotoUrlBtn").click(function(){
			...
			if(img!=""){
				...
				form1.find("img[name=idCardPhotoUrlImg]").attr("src",memberEdit.imgPath+"/"+img);
		...
		$("#mbs").each(function(){
			...
			$(this).on("click",function(){
				addTab("会员管理", memberEdit.appPath+ "/member/toMemberList.do?refereeId="+refereeId, "",function(){ 
				});
			});
        });
