					...
					var table = $('#memberPointsRuleList').dataTable(
						{
										...
										"dom" : "<'row'<'#memberPointsRuletool.col-xs-6'><'col-xs-6'f>r>"
												+ "t"
												+ "<'row'<'col-xs-3'l><'col-xs-3'i><'col-xs-6'p>>",
										initComplete : function() {
											$("#memberPointsRuletool").html("");
											$("#memberPointsRuletool").css("float", "right");
											$("#memberPointsRuletool").removeClass("col-xs-6");
											$("#memberPointsRuletool").append('<button type="button" class="btn btn-default btn-sm memberPointsRuletool-operate-add btnDefault" style="width: 95px; height: 32px; line-height: 25px; -webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px; background-color: #2b94fd" >新增</button>');
