...
var advertCensor = {
		...
		censorAdvert:function() {
			...
			form.ajaxSubmit({
				url : advertCensor.appPath + "/advert/updateAdvertStatus.do",
				type : "post",
				success : function(res) {
					var msg = res.msg;
					var code = res.code;
					if (code == "1") {
						bootbox.alert("<img src='res/img/tan.png' style='width: 29px;height: 29px;margin-top: -4px'>&nbsp;&nbsp;" + "文章审核操作成功", function() {
							closeTab("文章审核");
							$("#advertList").DataTable().ajax.reload(function(){});
						});
					} else {
						bootbox.alert("<img src='res/img/tan.png' style='width: 29px;height: 29px;margin-top: -4px'>&nbsp;&nbsp;" + "文章审核操作失败！");
					}
				},
