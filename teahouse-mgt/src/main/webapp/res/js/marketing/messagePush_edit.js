...
var messagePushEdit = {
		...
		init : function() {
			...
			$('#memberPushEditLists').dataTable( {
			   ...
			   "dom": "<'row'<'#memberPushEditTools.col-xs-6'><'col-xs-6'f>r>" +"t" +"<'row'<'col-xs-3'l><'col-xs-3'i><'col-xs-6'p>>",
			   initComplete: function () {
				   	$(this).find("thead tr th:first-child").prepend('');
					$("#memberPushEditTools").append('<button type="button"  class="btn btn-default btn-sm memberPush-batch-sel">确认</button>');
					$("#memberPushEditTools").append('<button type="button"  class="btn btn-default btn-sm memberPush-batch-close">关闭</button>');
