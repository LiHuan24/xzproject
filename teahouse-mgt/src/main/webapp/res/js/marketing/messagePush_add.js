...
var messagePushAdd = {
		...
		savemessagePush:function() {
			...
			$('#memberPushLists').dataTable( {
			   ...
			   "dom": "<'row'<'#memberPushTools.col-xs-6'><'col-xs-6'f>r>" +"t" +"<'row'<'col-xs-3'l><'col-xs-3'i><'col-xs-6'p>>",
			   initComplete: function () {
				   	$(this).find("thead tr th:first-child").prepend('');
					$("#memberPushTools").append('<button type="button"  class="btn btn-default btn-sm memberPush-batch-sel">确认</button>');
					$("#memberPushTools").append('<button type="button"  class="btn btn-default btn-sm memberPush-batch-close">关闭</button>');
