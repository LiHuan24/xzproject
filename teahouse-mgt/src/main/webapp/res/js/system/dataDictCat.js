        ...
        pageList:function(){
			...
			$("#dataDictList").dataTable({
				...
				"columns": [
					   ...
					   "dom": "<'row'<'#dataDictTools.col-xs-6'><'col-xs-6'f>r>" +"t" +"<'row'<'col-xs-3'l><'col-xs-3'i><'col-xs-6'p>>",
					   initComplete: function () {
						   $("#dataDictTools").html("");
						   $("#dataDictTools").css("float", "right");
						   $("#dataDictTools").removeClass("col-xs-6");
						   $("#dataDictTools").append('<button type="button" class="btn btn-default btn-sm dataDictTools-operate-addDataDictCat btnDefault" style="width: 95px; height: 32px; line-height: 25px; -webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px; background-color: #2b94fd">添加</button>');
