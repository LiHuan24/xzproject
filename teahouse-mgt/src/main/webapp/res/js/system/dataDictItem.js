        ...
        pageList:function(){
			...
			$("#dataDictItemList").dataTable({
				...
				"columns": [
					   ...
					   "dom": "<'row'<'#dataDictItemTools.col-xs-6'><'col-xs-6'f>r>" +"t" +"<'row'<'col-xs-3'l><'col-xs-3'i><'col-xs-6'p>>",
					   initComplete: function () {
						   $("#dataDictItemTools").html("");
						   $("#dataDictItemTools").css("float", "right");
						   $("#dataDictItemTools").removeClass("col-xs-6");
						   $("#dataDictItemTools").append('<button type="button" class="btn btn-default btn-sm dataDictItemTools-operate-addDataDictItem btnDefault" style="width: 95px; height: 32px; line-height: 25px; -webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px; background-color: #2b94fd">添加</button>');
