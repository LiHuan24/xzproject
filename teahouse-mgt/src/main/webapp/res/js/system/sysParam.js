			...
			pageList:function () {	
				...
				var table = $('#sysParamList').dataTable( {
				   ...
				   //"dom": "<'row'<'col-xs-2'l><'#sysParamtool.col-xs-4'><'col-xs-6'f>r>" +"t" +"<'row'<'col-xs-6'i><'col-xs-6'p>>",
					 "dom": "<'row'<'#sysParamTools.col-xs-6'><'col-xs-6'f>r>" +"t" +"<'row'<'col-xs-3'l><'col-xs-3'i><'col-xs-6'p>>",
					initComplete: function () {
						$("#sysParamTools").css("float", "right");
						$("#sysParamTools").removeClass("col-xs-6");
						$(this).find("thead tr th:first-child").prepend('<input type="checkbox">');
						
						$("#sysParamTools").append('<button type="button" class="btn btn-default btn-sm btnDefault" data-toggle="modal" data-target="#mySysParamModal" style="width: 95px; height: 32px; line-height: 25px; -webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px; background-color: #2b94fd">添加</button>');
						$("#sysParamTools button").addClass('btnDefault');
						$("#sysParamTools").append('<button type="button" class="btn btn-default btn-sm sysParam-batch-del btnDefault" style="width: 95px; height: 32px; line-height: 25px; -webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px; background-color: #2b94fd">批量删除</button>');
