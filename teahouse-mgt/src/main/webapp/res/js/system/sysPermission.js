...
//	    			async:false,
			...
			pageList:function () {	
				...
				$('#sysPermissionList').dataTable( {
				   ...
				   "dom": "<'row'<'#sysPermissionTools.col-xs-6'><'col-xs-6'f>r>" +"t" +"<'row'<'col-xs-3'l><'col-xs-3'i><'col-xs-6'p>>",
				   initComplete: function () {
					   $("#sysPermissionTools").css("float", "right");
					   $("#sysPermissionTools").removeClass("col-xs-6");
					   	$(this).find("thead tr th:first-child").prepend('<input type="checkbox">');
						$("#sysPermissionTools").append('<button type="button" class="btn btn-default btn-sm btnDefault" data-toggle="modal" data-target="#mySysPermissionModal" id="mySysPermission" style="width: 95px; height: 32px; line-height: 25px; -webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px; background-color: #2b94fd">添加</button>');
						$("#sysPermissionTools button").addClass('btnDefault');
						$("#sysPermissionTools").append('<button type="button" class="btn btn-default btn-sm sysPermission-batch-del btnDefault" style="width: 95px; height: 32px; line-height: 25px; -webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px; background-color: #2b94fd">批量删除</button>');
